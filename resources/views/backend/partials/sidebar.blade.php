...
<div class="page-sidebar-wrapper">
    ...
    <div class="page-sidebar navbar-collapse collapse">
        ...
        <ul class="page-sidebar-menu  page-header-fixed page-sidebar-menu-hover-submenu page-sidebar-menu-closed"
            ...
            <li class="nav-item {{ activeItem('project') }}">
                <a href="{{ route('backend.project.index') }}" class="nav-link nav-toggle">
                    <i class="fa fa-fw fa-newspaper-o"></i>
                    <span class="title">{{ trans('general.projects') }}</span>
                    <span class="selected"></span>
                    <span class="arrow open"></span>
                </a>
                <ul class="sub-menu">
                    <li class="nav-item start ">
                        <a href="{{ route('backend.project.index',['active' => true, 'ongoing' => true]) }}"
                           class="nav-link ">
                            <i class="icon-plus"></i>
                    ...
                    <li class="nav-item start ">
                        <a href="{{ route('backend.project.index',['expired' => true]) }}" class="nav-link ">
                            <i class="icon-plus"></i>
                            <span class="title">{{ trans('general.closed_projects') }}</span>
                        </a>
                    </li>
                    <li class="nav-item start ">
                        <a href="{{ route('backend.project.index') }}" class="nav-link ">
                            <i class="icon-plus"></i>
                            <span class="title">{{ trans('general.all_projects') }}</span>
                        </a>
                    </li>
                    <li class="nav-item start ">
                        <a href="{{ route('backend.project.create') }}" class="nav-link ">
                            <i class="icon-plus"></i>
                            <span class="title">{{ trans('general.create_new_project') }}</span>
                        </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item {{ activeItem('setting', ['contactus', 'aboutus']) }}">
                ...
                <ul class="sub-menu">
                    ...
                    <li class="nav-item ">
                        ...
                        <ul class="sub-menu">
                            <li class="nav-item">
                                <a href="{{ route('backend.gallery.index',['type' => 'user','element_id' => auth()->user()->id]) }}"
                                   class="nav-link">
                                    <i class="icon-camera"></i>Asad Galleries</a>
                            </li>
                            @if(auth()->user()->isSuper)
                                <li class="nav-item">
                                    <a href="{{ route('backend.gallery.create',['type' => 'user', 'element_id' => auth()->user()->id]) }}"
                                       class="nav-link">
                                        <i class="icon-link"></i> Create Gallery</a>
                                </li>
                            @endif
                        </ul>
                    </li>
