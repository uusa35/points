        ...
        <form class="horizontal-form" role="form" method="POST" action="{{ route('backend.order.store') }}" enctype="multipart/form-data">
            ...
            <div class="form-body">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="col-md-3 control-label">preffered_colors_1</label>
                            <div class="col-md-6">
                                <input type="text" id="hue-demo" name="preffered_colors_1" class="form-control demo" data-control="hue" value="#ff6161">
                            </div>
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="col-md-3 control-label">preffered_colors_2</label>
                            <div class="col-md-6">
                                <input type="text" id="hue-demo" name="preffered_colors_2" class="form-control demo" data-control="hue" value="#ff6161">
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="col-md-3 control-label">preffered_colors_3</label>
                            <div class="col-md-6">
                                <input type="text" id="hue-demo" name="preffered_colors_3" class="form-control demo" data-control="hue" value="#ff6161">
                            </div>
                        </div>
