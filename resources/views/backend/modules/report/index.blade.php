            ...
            <div class="portlet light ">
                ...
                <div class="portlet-body">
                    <div class="m-heading-1 border-green m-bordered">
                        ...
                        <p> {{ trans('message.backend_report_index') }}</p>
                    </div>
                                ...
                                <td>
                                    <div class="btn-group pull-right">
                                        ...
                                        <ul class="dropdown-menu pull-right" role="menu">
                                            ...
                                            <li>
                                                <a href="{{ route('backend.report.edit',$element->id) }}">
                                                    <i class="fa fa-fw fa-edit"></i>edit</a>
                                            </li>
                                            <li>
                                                <a href="{{ route('backend.activate',['model' => 'report','id' => $element->id]) }}">
                                                    <i class="fa fa-fw fa-xs fa-check-circle"></i> toggle active</a>
                                            </li>
                                            <li>
                                                <a data-toggle="modal" href="#" data-target="#basic"
                                                   data-title="Delete"
                                                   data-content="Are you sure you want to delete this report ? "
                                                   data-form_id="delete-{{ $element->id }}"
                                                >
                                                    <i class="fa fa-fw fa-recycle"></i> delete</a>
                                                <form method="post" id="delete-{{ $element->id }}"
                                                      action="{{ route('backend.report.destroy',$element->id) }}">
                                                    @csrf
