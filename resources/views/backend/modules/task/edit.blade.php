    ...
    <div class="portlet box blue">
        ...
        <div class="portlet-body form">
            <form class="horizontal-form" role="form" method="POST"
                  action="{{ route('backend.task.update', $element->id) }}" enctype="multipart/form-data">
                @csrf
                <input type="hidden" name="phase_id" value="{{ $element->phase_id }}">
                        ...
                        <div class="col-md-4">
                            <div class="form-group{{ $errors->has('date') ? ' has-error' : '' }}">
                                ...
                                <input id="date"
                                       ...
                                       class="form-control"
                                       name="date"
                                       value="{{ $element->date->format('Y-d-m') }}"
