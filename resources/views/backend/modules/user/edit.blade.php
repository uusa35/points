                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group{{ $errors->has('name_ar') ? ' has-error' : '' }}">
                            ...
                            <input id="name_ar" type="text" class="form-control" name="name_ar" value="{{ $element->name_ar }}"
                    ...
                    <div class="col-md-3">
                        <div class="form-group{{ $errors->has('name_en') ? ' has-error' : '' }}">
                            ...
                            <input id="name_en" type="text" class="form-control" name="name_en" value="{{ $element->name_en }}"
                    ...
                    <div class="col-md-3">
                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                            ...
                            <input id="email" type="text" class="form-control" name="email" value="{{ $element->email }}"
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group{{ $errors->has('caption_ar') ? ' has-error' : '' }}">
                            ...
                            <input id="caption_ar" type="text" class="form-control" name="caption_ar" value="{{ $element->caption_ar }}"
                    ...
                    <div class="col-md-6">
                        <div class="form-group{{ $errors->has('caption_en') ? ' has-error' : '' }}">
                            ...
                            <input id="caption_en" type="text" class="form-control" name="caption_en" value="{{ $element->caption_en }}"
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group{{ $errors->has('service_ar') ? ' has-error' : '' }}">
                            ...
                            <input id="service_ar" type="text" class="form-control" name="service_ar" value="{{ $element->service_ar }}"
                    ...
                    <div class="col-md-6">
                        <div class="form-group{{ $errors->has('service_en') ? ' has-error' : '' }}">
                            ...
                            <input id="service_en" type="text" class="form-control" name="service_en" value="{{ $element->service_en }}"
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group{{ $errors->has('address_ar') ? ' has-error' : '' }}">
                            ...
                            <input id="address_ar" type="text" class="form-control" name="address_ar" value="{{ $element->address_ar }}"
                    ...
                    <div class="col-md-6">
                        <div class="form-group{{ $errors->has('address_en') ? ' has-error' : '' }}">
                            ...
                            <input id="address_en" type="text" class="form-control" name="address_en" value="{{ $element->address_en }}"
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group{{ $errors->has('website') ? ' has-error' : '' }}">
                            ...
                            <input id="website" type="text" class="form-control" name="website" value="{{ $element->website }}"
                    ...
                    <div class="col-md-3">
                        <div class="form-group{{ $errors->has('facebook') ? ' has-error' : '' }}">
                            ...
                            <input id="facebook" type="text" class="form-control" name="facebook" value="{{ $element->facebook }}"
                    ...
                    <div class="col-md-3">
                        <div class="form-group{{ $errors->has('instagram') ? ' has-error' : '' }}">
                            ...
                            <input id="instagram" type="text" class="form-control" name="instagram" value="{{ $element->instagram }}"
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group{{ $errors->has('youtube') ? ' has-error' : '' }}">
                            ...
                            <input id="youtube" type="text" class="form-control" name="youtube" value="{{ $element->youtube }}"
                    ...
                    <div class="col-md-3">
                        <div class="form-group{{ $errors->has('twitter') ? ' has-error' : '' }}">
                            ...
                            <input id="twitter" type="text" class="form-control" name="twitter" value="{{ $element->twitter }}"
                    ...
                    <div class="col-md-3">
                        <div class="form-group{{ $errors->has('mobile') ? ' has-error' : '' }}">
                            ...
                            <input id="mobile" type="text" class="form-control" name="mobile" value="{{ $element->mobile }}"
                    ...
                    <div class="col-md-3">
                        <div class="form-group{{ $errors->has('phone') ? ' has-error' : '' }}">
                            ...
                            <input id="phone" type="text" class="form-control" name="phone" value="{{ $element->phone }}"
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group{{ $errors->has('whatsapp') ? ' has-error' : '' }}">
                            ...
                            <input id="whatsapp" type="text" class="form-control" name="whatsapp" value="{{ $element->whatsapp }}"
                    ...
                    <div class="col-md-3">
                        <div class="form-group{{ $errors->has('iphone') ? ' has-error' : '' }}">
                            ...
                            <input id="iphone" type="text" class="form-control" name="iphone" value="{{ $element->iphone }}"
                    ...
                    <div class="col-md-3">
                        <div class="form-group{{ $errors->has('android') ? ' has-error' : '' }}">
                            ...
                            <input id="android" type="text" class="form-control" name="android" value="{{ $element->android }}"
