    ...
    public function run()
    {
        ...
        foreach ($roles as $k => $v) {
            ...
            if ($role->name === 'super') {
                ...
                $role->update(['is_admin' => $v === 'admin' ? 1 : 0, 'is_visible' => true, 'is_super' => false, 'is_admin' => false, 'is_designer' => false,'is_client' => true]);
            } else if ($role->name === 'designer') {
                $role->update(['is_admin' => $v === 'admin' ? 1 : 0, 'is_visible' => true, 'is_super' => false, 'is_admin' => false, 'is_designer' => true,'is_client' => false]);
            }
        }
    }
}
